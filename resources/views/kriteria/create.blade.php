      ...
      <div class="card-body">
        <form action="/kriteria" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="input-nama" name="nama" placeholder="Masukkan Nama Kriteria">
          </div>
          <div class="form-group">
            <label for="input-bobot">Bobot Kriteria</label>
            <div class="input-group">
                <input type="number" class="form-control" id="input-bobot" name="bobot" placeholder="Masukkan Bobot Kriteria">
